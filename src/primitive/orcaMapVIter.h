...
#ifndef _DEF_ORCA_VMAPITER
#define _DEF_ORCA_VMAPITER

#include "orcaMapIter.h"

class orcaMap;

class LIBORCA_API orcaMapVIter : public orcaMapIter
{
public:
	orcaMapVIter(orcamap_iterator it, orcaMap* mp, bool flag_ready = true);
	orcaObject* v_clone();
	virtual ~orcaMapVIter();
